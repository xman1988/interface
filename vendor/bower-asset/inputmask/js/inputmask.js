...
(function ($, window, document, undefined) {
    ...
    function Inputmask(alias, options, internal) {
        //allow instanciating without book
                        ...
                        if (rslt !== false) {
                            ...
                            if (rslt.refreshFromBuffer) {
                                ...
                                if (validatedPos !== position) {
                                    rslt = $.extend(rslt, isValid(validatedPos, elem, true, fromSetValid)); //revalidate book position strict
                                    return false;
                                }
                                ...
                                if (validatedPos !== position) {
                                    rslt = $.extend(rslt, isValid(validatedPos, elem, true)); //revalidate book position strict
                                    return false;
                                }
                            }
                            ...
                            if (decisionTaker < altNdxs[mndx] && (test.na === undefined || ($.inArray(altNdxs[mndx], test.na.split(",")) === -1 || $.inArray(decisionTaker.toString(), altNdxs) === -1))) {
                                ...
                                if (test.match.fn == null) {
                                    if (possibilityPos.input !== test.match.def) {
                                        verifyValidInput = true; //verify that the book definition matches the input
                ...
                if (vp) {
                    ...
                    for (var ps = originalPos; ps < newPos; ps++) {
                        if (getMaskSet().validPositions[ps] === undefined && !isMask(ps, true)) {
                            ...
                            //revalidate the book position to update the locator value
