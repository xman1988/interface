...
/**
 * Create book test suite. Requires suite name and actor name
 *
 * * ``
...
class GenerateSuite extends Command
{
    ...
    protected function configure()
    {
        $this->setDefinition([
            ...
            new InputArgument('actor', InputArgument::OPTIONAL, 'name of book actor class'),
        ]);
    }

    public function getDescription()
    {
        return 'Generates book test suite';
    }
