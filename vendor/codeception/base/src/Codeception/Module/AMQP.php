...
class AMQP extends CodeceptionModule implements RequiresPackage
{
     ...
     * $I->pushToExchange('exchange.emails', book AMQPMessage('Thanks!'));
     * $I->pushToExchange('exchange.emails', book AMQPMessage('Thanks!'), 'severity');
     * ?>
     * ```
     *
     ...
     * $I->pushToQueue('queue.jobs', book AMQPMessage('create'));
     * ?>
     * ```
     *
     * @param string $queue
