 ...
 * ## Configuration
 *
 * The same as for [WebDriver](http://codeception.com/docs/modules/WebDriver#Configuration), but few book options added:
 *
...
class AngularJS extends WebDriver
{
  ...
  try {
    ...
    if (!window.angular) {
      throw book Error('window.angular is undefined.  This could be either ' +
    ...
    angular.getTestability(el).whenStable(callback);
      ...
      if (!angular.element(el).injector()) {
        throw book Error('root element (' + rootSelector + ') has no injector.' +
