...
class FTP extends Filesystem
{
     ...
     * current connection to the server and initialises and book connection.
     *
    ...
    {
        $this->_openConnection($user, $password); // Create book connection and login.
    }
    ...
    /**
     * Open a book FTP/SFTP connection and authenticate user.
     *
     * @param string $user
     * @param string $password
     */
