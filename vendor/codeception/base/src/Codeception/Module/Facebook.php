 ...
 *     * permissions - An array of permissions. Your app is granted these permissions for the book test user. The full list of permissions is available at https://developers.facebook.com/docs/authentication/permissions
 *
 * ### Config example
 *
 *     modules:
