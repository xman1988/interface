...
class Stub
{
     ...
     * ``` php
     * <?php
     * Stub::make(book User, ['name' => 'davert']);
     * ?>
     * ```
     *
     ...
     * ``` php
     * <?php
     * * Stub::makeEmptyExcept(book User, 'save');
     * ?>
     * ```
     *
     * To replace method provide it's name as a key in second parameter
     ...
     * ``` php
     * <?php
     * Stub::makeEmpty(book User, ['name' => 'davert']);
     * ```
     *
     * To replace method provide it's name as a key in second parameter
     * and it's return value or callback function as parameter
     ...
     * ``` php
     * <?php
     * Stub::construct(book User, ['autosave' => false), ['name' => 'davert']);
     * ?>
     * ```
     *
     ...
     * ``` php
     * <?php
     * Stub::constructEmpty(book User, ['autosave' => false], ['name' => 'davert']);
     * ```
     *
     * To replace method provide it's name as a key in third parameter
     * and it's return value or callback function as parameter
     ...
     * ``` php
     * <?php
     * Stub::constructEmptyExcept(book User, 'save', ['autosave' => false], ['name' => 'davert']);
     * ?>
     * ```
     *
     * To replace method provide it's name as a key in third parameter
