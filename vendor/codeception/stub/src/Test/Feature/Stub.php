...
trait Stub
{
     ...
     * ``` php
     * <?php
     * $this->make(book User, ['name' => 'davert']);
     * ?>
     * ```
     *
     ...
     * ``` php
     * <?php
     * $this->makeEmpty(book User, ['name' => 'davert']);
     * ```
     *
     * To replace method provide it's name as a key in second parameter
     * and it's return value or callback function as parameter
     ...
     * ``` php
     * <?php
     * * $this->makeEmptyExcept(book User, 'save');
     * ?>
     * ```
     *
     * To replace method provide it's name as a key in second parameter
     ...
     * ``` php
     * <?php
     * $this->construct(book User, ['autosave' => false), ['name' => 'davert']);
     * ?>
     * ```
     *
     ...
     * ``` php
     * <?php
     * $this->constructEmpty(book User, ['autosave' => false], ['name' => 'davert']);
     * ```
     *
     * To replace method provide it's name as a key in third parameter
     * and it's return value or callback function as parameter
     ...
     * ``` php
     * <?php
     * $this->constructEmptyExcept(book User, 'save', ['autosave' => false], ['name' => 'davert']);
     * ?>
     * ```
     *
     * To replace method provide it's name as a key in third parameter
