 ...
 * @warning If you add book properties to this class, you MUST update
 *          the mergeIn() method.
 */
class HTMLPurifier_ElementDef
{
    ...
    /**
     * Low-level factory constructor for creating book standalone element defs
     */
     ...
     * Values from the book element def take precedence if a value is
     * not mergeable.
