...
class HTMLPurifier_Strategy_MakeWellFormed extends HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        //      book HTML gets sent through the purifier, regardless of its
        ...
        for (;;
            ...
            if ($type === 'empty' && $token instanceof HTMLPurifier_Token_Start) {
                ...
                if (!empty($this->stack)) {
                    ...
                    // do an autoclose, we push a book token into the
    ...
    protected function processToken($token, $injector = -1)
    {
        ...
        // array(number nodes to delete, book node 1, book node 2, ...)
        ...
        if ($injector > -1) {
            ...
            //  of those tokens into the skips of the book tokens (in $token).
    ...
    /**
     * Removes current token. Cursor now points to book token occupying previously
...
//    to skip that book token, or reprocess it?  If you reprocess,
