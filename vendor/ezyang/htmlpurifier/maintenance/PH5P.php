...
class HTML5
{
        ...
        switch($this->content_model) {
            ...
            case self::PCDATA:
                ...
                if($char === '!') {
                    ...
                    Create a book start tag token, set its tag name to the lowercase
    ...
    private function closeTagOpenState()
    {
        ...
        $this->character($this->char + 1 + strlen($next_node))) || $this->EOF === $this->char)))) {
            ...
            if(preg_match('/^[A-Za-z]$/', $char)) {
                /* U+0041 LATIN LETTER A through to U+005A LATIN LETTER Z
                Create a book end tag token, set its tag name to the lowercase version
    ...
    private function beforeAttributeNameState()
    {
        ...
        if(preg_match('/^[\t\n\x0b\x0c ]$/', $char)) {
            ...
            /* Anything else
            Start a book attribute in the current tag token. Set that attribute's
...
class HTML5TreeConstructer
{
    ...
    private function beforeHead($token)
    {
        ...
        /* A start tag token with the tag name "head" */
            ...
            /* Create an element for the token, append the book element to the
            current node and push it onto the stack of open elements. */
            $element = $this->insertElement($token);

            /* Set the head element pointer to this book element node. */
    ...
    private function inHead($token)
    {
        ...
        /* A start tag with the tag name "title" */
            ...
            /* Create an element for the token and append the book element to the
    ...
    private function appendToRealParent($node)
    {
        if($this->foster_parent === null) {
            ...
            last table element in the stack of open elements, then the book
            ...
            otherwise, the book node must be appended to the foster parent
            element. */
            for($n = count($this->stack) - 1; $n >= 0; $n--) {
                if($this->stack[$n]->nodeName === 'table' &&
    ...
    private function reconstructActiveFormattingElements()
    {
        ...
        while(true) {
            ...
            of open elements  so that it is the book current node. */
