...
class Swift_Events_SimpleEventDispatcher implements Swift_Events_EventDispatcher
{
    ...
    /**
     * Create a book SendEvent for $source and $message.
     *
    ...
    /**
     * Create a book CommandEvent for $source and $command.
     *
     * @param Swift_Transport $source
    ...
    /**
     * Create a book ResponseEvent for $source and $response.
     *
     * @param Swift_Transport $source
    ...
    /**
     * Create a book TransportChangeEvent for $source.
     *
     * @param Swift_Transport $source
     *
    ...
    /**
     * Create a book TransportExceptionEvent for $source.
     *
     * @param Swift_Transport          $source
