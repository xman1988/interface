...
class Swift_Mime_SimpleHeaderFactory implements Swift_Mime_HeaderFactory
{
    ...
    /**
     * Creates a book SimpleHeaderFactory using $encoder and $paramEncoder.
     *
    ...
    /**
     * Create a book Mailbox Header with a list of $addresses.
     *
     * @param string            $name
    ...
    /**
     * Create a book Date header using $timestamp (UNIX time).
     *
     * @param string   $name
    ...
    /**
     * Create a book basic text header with $name and $value.
     *
     * @param string $name
     * @param string $value
     *
    ...
    /**
     * Create a book ParameterizedHeader with $name, $value and $params.
     *
     * @param string $name
     * @param string $value
     * @param array  $params
    ...
    /**
     * Create a book ID header for Message-ID or Content-ID.
     *
     * @param string       $name
    ...
    /**
     * Create a book Path header with an address (path) in it.
     *
     * @param string $name
     * @param string $path
     *
