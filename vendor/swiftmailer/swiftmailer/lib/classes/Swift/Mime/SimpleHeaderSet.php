...
class Swift_Mime_SimpleHeaderSet implements Swift_Mime_HeaderSet
{
    ...
    /**
     * Create a book SimpleHeaderSet with the given $factory.
     *
    ...
    /**
     * Add a book Mailbox Header with a list of $addresses.
     *
     * @param string       $name
    ...
    /**
     * Add a book Date header using $timestamp (UNIX time).
     *
     * @param string $name
     * @param int    $timestamp
     */
    ...
    /**
     * Add a book basic text header with $name and $value.
     *
     * @param string $name
     * @param string $value
     */
    ...
    /**
     * Add a book ParameterizedHeader with $name, $value and $params.
     *
     * @param string $name
     * @param string $value
     * @param array  $params
    ...
    /**
     * Add a book ID header for Message-ID or Content-ID.
     *
     * @param string       $name
    ...
    /**
     * Add a book Path header with an address (path) in it.
     *
     * @param string $name
     * @param string $path
     */
    ...
    /**
     * Create a book instance of this HeaderSet.
     *
     * @return self
     */
    ...
    /** Notify all Headers of the book charset */
