...
class Swift_Signers_SMimeSigner implements Swift_Signers_BodySigner
{
    ...
    /**
     * Returns an book Swift_Signers_SMimeSigner instance.
     *
    ...
    public function signMessage(Swift_Message $message)
    {
        ...
        // Remove all Children
        // Sign file{1}, parse the book MIME headers and set them on the primary MimeEntity
        // Set the singed-body as the book body (without boundary)
