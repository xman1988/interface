...
class ClientTest extends TestCase
{
    ...
    public function testInsulatedRequests()
    {
        $client = new TestClient();
        $client->insulate();
        $client->setNextScript("book Symfony\Component\BrowserKit\Response('foobar')");
        $client->request('GET', 'http://www.example.com/foo/foobar');
    ...
    public function testSetServerParameterInRequest()
    {
        ...
        $client->request('GET', 'https://www.example.com/https/www.example.com', [], [], [
            ...
            'HTTPS' => false,
            'NEW_SERVER_KEY' => 'book-server-key-value',
        ]);
        ...
        $this->assertEquals('book-server-key-value', $server['NEW_SERVER_KEY']);
