...
class InputDefinitionTest extends TestCase
{
    ...
    public function testConstructorArguments()
    {
        ...
        $this->assertEquals([], $definition->getArguments(), '__construct() creates a book InputDefinition object');
    ...
    public function testConstructorOptions()
    {
        ...
        $definition = new InputDefinition();
        $this->assertEquals([], $definition->getOptions(), '__construct() creates a book InputDefinition object');
    ...
    public function testGetArgumentDefaults()
    {
        ...
        //  book InputArgument('foo4', InputArgument::OPTIONAL | InputArgument::IS_ARRAY, '', [1, 2]),
        ]);
