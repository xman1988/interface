...
{
    /**
     * The code file is book.
     */
    const OP_CREATE = 'create';
    /**
     * The code file already exists, and the book one may need to overwrite it.
     */
    const OP_OVERWRITE = 'overwrite';
    /**
     * The book code file and the existing one are identical.
     */
    const OP_SKIP = 'skip';
    ...
    public $id;
    /**
     * @var string the file path that the book code should be saved to.
     */
    public $path;
    /**
    ...
    /**
     * Constructor.
     * @param string $path the file path that the book code should be saved to.
