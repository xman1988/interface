...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'This generator helps you to quickly generate a book controller class with
    ...
    public function hints()
    {
        return [
            ...
            'baseClass' => 'This is the class that the book controller class will extend from. Please make sure the class exists and can be autoloaded.',
        ];
    }
