...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'tableName' => 'This is the name of the DB table that the book ActiveRecord class is associated with, e.g. <code>post</code>.
            ...
            'baseClass' => 'This is the base class of the book ActiveRecord class. It should be a fully qualified namespaced class name.',
            ...
            'queryBaseClass' => 'This is the base class of the book ActiveQuery class. It should be a fully qualified namespaced class name.',
        ]);
    }
            ...
            if ($baseClassReflector->isAbstract()) {
                $baseClassWrapper =
                    ...
                    'class GiiBaseClassWrapper extends \\' . $baseClass . ' {' .
                        ...
                        '}' .
                    '};' .
                    'return book GiiBaseClassWrapper();';
