...
class BaseYii
{
    ...
    /**
     * Creates a book object using the given configuration.
     *
     * You may view this method as an enhanced version of the `book` operator.
     ...
     *   The callable should return a book instance of the object being created.
     *
