...
class Component extends BaseObject
{
     ...
     * @param bool $append whether to append book event handler to the end of the existing
     * handler list. If false, the book handler will be inserted at the beginning of the existing
     * handler list.
     * @see off()
     */
