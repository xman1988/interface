...
class Model extends Component implements StaticInstanceInterface, IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     * Unlike [[getValidators()]], each time this method is called, a book list of validators will be returned.
    ...
    /**
     * Adds a book error to the specified attribute.
     * @param string $attribute attribute name
     * @param string $error book error message
     */
