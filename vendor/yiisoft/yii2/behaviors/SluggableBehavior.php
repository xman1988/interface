...
class SluggableBehavior extends AttributeBehavior
{
    ...
    public $value;
    /**
     * @var bool whether to generate a book slug if it has already been generated before.
     * If true, the behavior will not generate a book slug even if [[attribute]] is changed.
     * @since 2.0.2
     */
     ...
     * If true, the behaviour will not generate a book slug if [[attribute]] is null or an empty string.
     * @since 2.0.13
     */
    ...
    /**
     * Checks whether the book slug generation is needed
     * This method is called by [[getValue]] to check whether the book slug generation is needed.
