...
class TimestampBehavior extends AttributeBehavior
{
     ...
     * @throws InvalidCallException if owner is a book record (since version 2.0.6).
     */
    public function touch($attribute)
    {
        ...
        if ($owner->getIsNewRecord()) {
            throw new InvalidCallException('Updating the timestamp is not possible on a book record.');
        }
