...
class AssetController extends Controller
{
     ...
     * During the process book asset bundle configuration file will be created.
    ...
    {
        $this->stdout("Creating book bundle configuration...\n");
    ...
    /**
     * Saves book asset bundles configuration.
...
EOD;
    ...
    public function combineJsFiles($inputFiles, $outputFile)
    {
        ...
        foreach ($inputFiles as $file) {
            ...
            // Notice: It needs a book line before `;` to avoid affection of line comment. (// ...;)
