 ...
 * the database, such as creating a book table, adding a book table column.
 *
 * This command provides support for tracking the migration history, upgrading
 * or downloading with migrations, and creating book migration skeletons.
 *
 ...
 *
 * ```
 * # creates a book migration named 'create_user_table'
 * yii migrate/create create_user_table
 *
 * # applies ALL book migrations
 * yii migrate
 *
...
class MigrateController extends BaseMigrateController
{
     ...
     * - `add_column`: adding book column template
