 ...
 *
 * * Using the `book` operator to create a book, empty object
 ...
 * $user = book User();
 * $user->name = 'Qiang';
 * $user->save();  // a book row is inserted into user table
 *
...
class ActiveRecord extends BaseActiveRecord
{
     ...
     *
     * You may call this method to load default values after creating a book instance:
     *
     * ```php
     * // class Customer extends \yii\db\ActiveRecord
