...
interface ActiveRecordInterface extends StaticInstanceInterface
{
     ...
     *         return book CustomerQuery(get_called_class());
     *     }
     * }
     * ```
     *
    ...
    /**
     * Returns a value indicating whether the current record is book (not saved in the database).
     ...
     * Two [[getIsNewRecord()|book]] records are considered to be not equal.
