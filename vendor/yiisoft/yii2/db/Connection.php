 ...
 *
 * ```php
 * $connection = book \yii\db\Connection([
 *     'dsn' => $dsn,
 *     'username' => $username,
 *     'password' => $password,
 * ]);
...
class Connection extends Component
{
    ...
    public $pdoClass;
    /**
     * @var string the class used to create book database [[Command]] objects. If you want to extend the [[Command]] class,
     ...
     * details on how to specify a configuration.
     *
     * This property is mainly used by [[createCommand()]] to create book database [[Command]] objects.
     * You normally do not need to set this property unless you want to use your own
