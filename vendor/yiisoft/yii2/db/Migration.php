...
class Migration extends Component implements MigrationInterface
{
    ...
    /**
     * Builds and executes a SQL statement for creating a book DB table.
     *
    ...
    /**
     * Builds and executes a SQL statement for adding a book DB column.
     ...
     * @param string $type the book column type. The [[QueryBuilder::getColumnType()]] method will be invoked to convert abstract column type (if any)
     * into the physical one. Anything that is not recognized as abstract type will be kept in the generated SQL.
     * For example, 'string' will be turned into 'varchar(255)', while 'string not null' will become 'varchar(255) not null'.
     */
    ...
    /**
     * Builds and executes a SQL statement for creating a book index.
