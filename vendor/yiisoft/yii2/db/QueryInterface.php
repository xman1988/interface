...
interface QueryInterface
{
     ...
     *   `['in', 'user_id', (book Query())->select('id')->from('users')->where(['active' => 1])]`
     *
     ...
     *   `['exists', (book Query())->select('id')->from('users')->where(['active' => 1])]` will result in the following SQL expression:
     ...
     * @param array $condition the book WHERE condition. Please refer to [[where()]]
