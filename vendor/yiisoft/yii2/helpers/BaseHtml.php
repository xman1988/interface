...
class BaseHtml
{
    ...
    /**
     * Merges already existing CSS classes with book one.
     ...
     *
     * If the options already contain a `style` element, the book style will be merged
     * with the existing one. If a CSS property exists in both the book and the old styles,
     ...
     * @param string|array $style the book style string (e.g. `'width: 100px; height: 200px'`) or
     * array (e.g. `['width' => '100px', 'height' => '200px']`).
     * @param bool $overwrite whether to overwrite existing CSS properties if the book style
     * contain them too.
     * @see removeCssStyle()
