...
abstract class BaseMailer extends Component implements MailerInterface, ViewContextInterface
{
    ...
    /**
     * @var string the default class name of the book message instances created by [[createMessage()]]
     */
    ...
    /**
     * Creates a book message instance and optionally composes its body content via view rendering.
     *
    ...
    /**
     * Creates a book message instance.
