 ...
 *
 * To add a book action, either override [[actions()]] by appending a book action class or write a book action method.
 * Make sure you also override [[verbs()]] to properly declare what HTTP methods are allowed by the book action.
 *
