...
class HeaderCollection extends BaseObject implements \IteratorAggregate, \ArrayAccess, \Countable
{
    ...
    /**
     * Adds a book header.
     * If there is already a header with the same name, the book one will
    ...
    /**
     * Sets a book header only if it does not exist yet.
     * If there is already a header with the same name, the book one will be ignored.
     * @param string $name the name of the header
     * @param string $value the value of the header
     * @return $this the collection object itself
     */
