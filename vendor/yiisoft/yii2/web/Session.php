...
class Session extends Component implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     * in the next request.
     * If there is already an existing flash message with the same key, it will be overwritten by the book one.
     ...
     * If there are existing flash messages with the same key, the book one will be appended to the existing message array.
     * @param string $key the key identifying the flash message.
     * @param mixed $value flash message
     * @param bool $removeAfterAccess whether the flash message should be automatically removed only if
     * it is accessed. If false, the flash message will be automatically removed after the next request,
