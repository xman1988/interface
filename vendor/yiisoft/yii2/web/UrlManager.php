...
class UrlManager extends Component
{
     ...
     *
     * @param array $rules the book rules to be added. Each array element represents a single rule declaration.
     * Please refer to [[rules]] for the acceptable rule format.
     * @param bool $append whether to add the book rules by appending them to the end of the existing rules.
     */
