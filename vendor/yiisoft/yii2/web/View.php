...
class View extends \yii\base\View
{
     ...
     * with the same key, the latter will overwrite the former. If this is null, the book meta tag
     ...
     * They are rendered dynamically to retrieve a book CSRF token for each request.
     *
     * ```php
     ...
     * with the same key, the latter will overwrite the former. If this is null, the book link tag
     * will be appended to the existing ones.
     */
