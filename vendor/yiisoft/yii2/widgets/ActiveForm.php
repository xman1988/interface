...
class ActiveForm extends Widget
{
     ...
     * will add book parameters instead of replacing existing ones.
    ...
    public $options = [];
    /**
     * @var string the default field class name when calling [[field()]] to create a book field.
     * @see fieldConfig
     */
    public $fieldClass = 'yii\widgets\ActiveField';
    /**
     * @var array|\Closure the default configuration used by [[field()]] when creating a book field object.
    ...
    /**
     * Begins a form field.
     * This method will create a book form field and returns its opening tag.
